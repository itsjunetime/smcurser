...
const CMD_HELP: [&str; 50] = [
	...
	"    \x1b[1m--rest-host\x1b[0m <value>         The hostname of device which you are trying to connect to",
	"                                Default:",
	"    \x1b[1m--fallback-host\x1b[0m <value>     The fallback host to connect to, if the host fails",
	"                                Default:",
	"    \x1b[1m--rest-port\x1b[0m <value>         The port on which SMServer is running on the host device",
	"                                Default: 8741",
	"    \x1b[1m--socket-host\x1b[0m <value>       The host on which the socket is running (generally not needed)",
	"                                Default: Same as server host",
	"    \x1b[1m--socket-port\x1b[0m <value>       The port on which the SMServer websocket is running on the host device",
	"                                Default: 8740",
	"    \x1b[1m--remote-url\x1b[0m <value>        The address of the remote server which is hosting the websocket connections. If this value is specified, SMCurser will attempt to connect only through remote websockets, as opposed to the local REST API",
	"                                Default: None",
	"    \x1b[1m--remote-id\x1b[0m <value>         The ID of the remote connection",
	"                                Default: None",
	"    \x1b[1m--password\x1b[0m <value>          The password to try to connect to the host device with",
	"                                Default: toor",
	"    \x1b[1m--chat-indicator\x1b[0m <value>    The character to use to indicate the currently selected chat",
	"                                Default: >",
	"    \x1b[1m--unread-indicator\x1b[0m <value>  The character to use to indicate all chats with unread messages",
	"                                Default: •",
	"    \x1b[1m--chat-underline\x1b[0m <value>    The character to repeat to create the underline of the text messages",
	"                                Default: ▔",
	"    \x1b[1m--chats-title\x1b[0m <value>       The string to use as the title of the chats box",
	"                                Default: | chats |",
	"    \x1b[1m--messages-title\x1b[0m <value>    The string to use as the title of the messages box",
	"                                Default: | messages |",
	"    \x1b[1m--input-title\x1b[0m <value>       The string to use as the title of the input box",
	"                                Default: | input here :) |",
	"    \x1b[1m--help-title\x1b[0m <value>        The string to use as the title of the help box",
	"                                Default: | help |",
	"    \x1b[1m--to-title\x1b[0m <value>          The string to use as the title of the address box in the new composition view",
	"                                Default: | to: |",
	"    \x1b[1m--compose-title\x1b[0m <value>     The string to use as the title of the body box in the new composition view",
	"                                Default: | message: |",
	"    \x1b[1m--theme\x1b[0m <value>             The colorscheme to use",
	"                                Default: forest",
	"    \x1b[1m--poll-input\x1b[0m <value>        The amount of milliseconds to poll for input",
	"                                Default: 10",
	"    \x1b[1m--timeout\x1b[0m <value>           The timeout for API queries in seconds",
	"                                Default: 10",
	"    \x1b[1m--colorscheme-file\x1b[0m <value>  The file that SMCurser should parse to find custom colorschemes",
